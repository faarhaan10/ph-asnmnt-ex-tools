...
const focus =
  "<button id='focus' type='button' class='btn btn btn-danger text-bold btn-sm mb-2' title='Add mark'>Focus</button>";
const openModal =
  "<button id='openModal' type='button' class='btn btn-danger text-bold btn-sm mb-2' title='Open 1st assignment'>Open</button>";
const closeModal =
  "<button id='closeModal' type='button' class='btn btn-danger text-bold btn-sm mb-2' title='Close assignment modal'>Close</button>";
const pressE =
  "<button id='pressE' type='button' class='btn btn-danger text-bold btn-sm mb-2' title='Press ] key dynamically'>]</button>";
const assimentAdd =
  "<button id='addAssignment' type='button' class='btn btn-danger text-bold btn-sm mb-2' title='Add 10 assignments'>Add</button>";
const unassign =
  "<button id='unassign' type='button' class='btn btn-danger text-bold btn-sm mb-2' title='Unasign single assignment'>UnAs</button>";
const fullMark =
